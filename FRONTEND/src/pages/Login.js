    ...
    <div class="h-screen flex">
          ...
          justify-around items-center">
            ...
            <div class="w-full mx-auto px-20 flex-col items-center space-y-6">
              <h1 class="text-white font-bold text-4xl font-sans">EVLI SMS </h1>
              <p class="text-white mt-1">Registration and Accounts</p>
          ...
          <div class="flex w-full lg:w-1/2 justify-center items-center bg-white space-y-8">
            ...
            <form class="bg-white rounded-md shadow-2xl p-5">
              ...
              <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                ...
                <input id="email" class=" pl-2 w-full outline-none border-none" type="email" name="email" placeholder="Username" />
              </div>

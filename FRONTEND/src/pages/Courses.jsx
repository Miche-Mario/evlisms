                ...
                <table className="min-w-max w-full ">
                  ...
                  <tbody className="text-gray-600  text-sm font-light">
                    { courses.map((course, index) => (
                        ...
                        <td className=" py-3 px-3 text-center">
                          <div className="flex items-center justify-center">
                            <span className="font-medium">{course.course.coursename}</span>
                          </div>
                        </td>
                        <td className=" py-3 px-3 text-center">
                          <span className="bg-green-600 text-white py-1 px-3 rounded-full text-xs">{course.classtype.classtypename}</span>
                        </td>
                        <td className=" py-3 px-3 text-center">
                          <div className="flex items-center justify-center">
                            <span className="font-medium">{course.language.languagename}</span>
                          </div>
                        </td>
                        <td className=" py-3 px-3 text-center">
                          <div className="flex items-center justify-center">

...
const Classtype = () => {
  ...
  const deleteClasstype = async (userId) => {
    await axios.delete(`${process.env.REACT_APP_BASE_URL}/classtype/${userId}`);
    getClasstypes();
    navigate(0);
  }
  ...
  const saveClasstype = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${process.env.REACT_APP_BASE_URL}/classtype`, {
  ...
  return (
    <Layout >
      ...
      >
        <Box sx={style} >
          <p class="text-white text-xl p-3  bg-dark-purple w-full">Class Type DETAILS</p>
          <form onSubmit={saveClasstype}>
      ...
      <div className='m-3'>
        <div>
          <legend className='p-1 ml-3 text-xl text-blue-700'>Class Type</legend>
            <div className='flex'>
          ...
          <div className='m-3 mb-0 '>
            <table className="w-[40rem]">
              ...
              <tbody className="text-gray-600  text-sm font-light">
                ...
                <tr key={classtype.uuid} className=" border-gray-400  hover:bg-gray-100 border-b-2">
                  ...
                  <div className="flex items-center justify-center">
                      <span className="font-medium uppercase">{classtype.classtypename}</span>
                    </div>
                  </td>
                  <td className=" py-3 px-3 text-center  border border-dark-purple">
                  <div className="flex item-center justify-center">
                          <div>
                            <Link
                               to={`/classtype/edit/${classtype.uuid}`}
                            >
                          ...
                          <div className='ml-3'>
                            ...
                            <button
                              className='flex items-center p-1 bg-red text-white text-[1rem]'
                                onClick={() => handleOpen1(classtype.uuid)}
                            >
